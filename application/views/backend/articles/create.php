        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Form Tambah Data Artikel</h2>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal" action="<?= base_url('dashboard/create_article'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-11">
                                        <textarea name="content" id="" class="ckeditor" cols="30" rows="10"><?= set_value('content'); ?></textarea>
