                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="hero__btn-area">
                                <a href="all-products.html" class="btn btn--round btn--lg">Lihat Semua Produk</a>
                                <a href="all-products.html" class="btn btn--round btn--lg">Lihat Semua Artikel</a>
                            </div>
                            <!-- end .hero__btn-area-->
                        </div>
                        <!-- end /.col-md-12 -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature">
                        ...
                        <div class="feature__desc">
                            <p>
                                Berdiskusi dengan instruktur dan santri lain untuk memecahkan permasalahan dan menambah pengetahuan
                            </p>
                        </div>
                    </div>
                    <!-- end /.feature -->
                    ...
                    <div class="featured-product-slider prod-slider1">
                        <div class="featured__single-slider">
                            <div class="featured__preview-img">
                                <img src="<?= base_url('assets/frontend/'); ?>images/featprod.jpg" alt="Featured products">
                                <div class="prod_btn">
                            ...
                            <div class="featured__product-description">
                                <div class="product-desc desc--featured">
                                    ...
                                    <ul class="titlebtm">
                                        <li>
                                            <img class="auth-img" src="<?= base_url('assets/frontend/'); ?>images/auth.jpg" alt="author image">
                                            <p>
                                                <a href="#">AazzTech</a>
                                            </p>
                                        </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?= base_url('assets/frontend/'); ?>images/p1.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?= base_url('assets/frontend/'); ?>images/p2.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="<?= base_url('assets/frontend/'); ?>images/auth2.jpg" alt="author image">
                                    <p>
                                        <a href="#">AazzTech</a>
                                    </p>
                                </li>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?= base_url('assets/frontend/'); ?>images/p3.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="<?= base_url('assets/frontend/'); ?>images/auth3.jpg" alt="author image">
                                    <p>
                                        <a href="#">AazzTech</a>
                                    </p>
                                </li>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?= base_url('assets/frontend/'); ?>images/p4.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?= base_url('assets/frontend/'); ?>images/p5.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="<?= base_url('assets/frontend/'); ?>images/p6.jpg" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
...
=================================-->
    <section class="counter-up-area bgimage">
        <div class="bg_image_holder">
            <img src="<?= base_url('assets/frontend/'); ?>images/countbg.jpg" alt="">
        </div>
        <!-- start .container -->
            ...
            <div class="row">
                <div class="col-md-6 no-padding">
                    <div class="proposal proposal--left bgimage">
                        <div class="bg_image_holder">
                            <img src="<?= base_url('assets/frontend/'); ?>images/bbg.png" alt="prop image">
                        </div>
                        <div class="content_above">
                            <div class="proposal__icon ">
                                <img src="<?= base_url('assets/frontend/'); ?>images/buy.png" alt="Buy icon">
                            </div>
                ...
                <div class="col-md-6 no-padding">
                    <div class="proposal proposal--right">
                        <div class="bg_image_holder">
                            <img src="<?= base_url('assets/frontend/'); ?>images/sbg.png" alt="this is magic">
                        </div>
                        <div class="content_above">
                            <div class="proposal__icon">
                                <img src="<?= base_url('assets/frontend/'); ?>images/sell.png" alt="Sell icon">
                            </div>
                            <div class="proposal__content ">
                ...
                <div class="col-md-12">
                    <div class="testimonial-slider">
                        <div class="testimonial">
                            <div class="testimonial__about">
                                <div class="avatar v_middle">
                                    <img src="<?= base_url('assets/frontend/'); ?>images/test1.jpg" alt="Testimonial Avatar">
                                </div>
                        ...
                        <div class="testimonial">
                            <div class="testimonial__about">
                                <div class="avatar v_middle">
                                    <img src="<?= base_url('assets/frontend/'); ?>images/test2.jpg" alt="Testimonial Avatar">
                                </div>
                                <div class="name-designation v_middle">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="news">
                        <div class="news__thumbnail">
                            <img src="<?= base_url('assets/frontend/'); ?>images/news1.png" alt="News Thumbnail">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="news">
                        <div class="news__thumbnail">
                            <img src="<?= base_url('assets/frontend/'); ?>images/news2.png" alt="News Thumbnail">
                        </div>
                        <div class="news__content">
                            <a href="#" class="news-title">
