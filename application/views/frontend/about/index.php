...
<section class="about_hero bgimage">
    <div class="bg_image_holder">
        <img src="<?= base_url('assets/frontend/'); ?>images/about_hero.jpg" alt="">
    </div>
                ...
                <div class="about_hero_contents">
                    ...
                    <div class="about_hero_btns">
                        <a href="#" class="play_btn" data-toggle="modal" data-target="#myModal">
                            <img src="<?= base_url('assets/frontend/'); ?>images/play_btn.png" alt="PLay">Play Quick Video</a>
...
<section class="about_mission">
    <div class="content_block1">
        ...
        <div class="content_image bgimage">
            <div class="bg_image_holder">
                <img src="<?= base_url('assets/frontend/'); ?>images/ab1.jpg" alt="">
            </div>
        </div>
    </div>
    <!-- end /.about -->
    ...
    <div class="content_block2">
        ...
        <div class="content_image2 bgimage">
            <div class="bg_image_holder">
                <img src="<?= base_url('assets/frontend/'); ?>images/ab2.jpg" alt="">
            </div>
        </div>
    </div>
    <!-- end /.mission-->
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="single_team_member">
                    <figure>
                        <img src="<?= base_url('assets/frontend/'); ?>images/team1.jpg" alt="Team Member">
                        <figcaption>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="single_team_member">
                    <figure>
                        <img src="<?= base_url('assets/frontend/'); ?>images/team2.jpg" alt="Team Member">
                        <figcaption>
                            <div class="name_desig">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="single_team_member">
                    <figure>
                        <img src="<?= base_url('assets/frontend/'); ?>images/team3.jpg" alt="Team Member">
                        <figcaption>
                            <div class="name_desig">
                                <h4>Tomat Notfrut</h4>
                                <p>Js Developer</p>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="single_team_member">
                    <figure>
                        <img src="<?= base_url('assets/frontend/'); ?>images/team4.jpg" alt="Team Member">
                        <figcaption>
                            <div class="name_desig">
                                <h4>Naro Sundor</h4>
                                <p>CTO</p>
...
<section class="partner-area section--padding partner--area2 bgimage">
    <div class="bg_image_holder">
        <img src="<?= base_url('assets/frontend/'); ?>images/fn.jpg" alt="">
    </div>
    <!-- start container -->
    <div class="container">
        <!-- start row -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="partners">
                    <div class="partner">
                        <img src="<?= base_url('assets/frontend/'); ?>images/cl1.png" alt="partner image">
                    </div>
                    <div class="partner">
                        <img src="<?= base_url('assets/frontend/'); ?>images/cl2.png" alt="partner image">
                    </div>
                    <div class="partner">
                        <img src="<?= base_url('assets/frontend/'); ?>images/cl3.png" alt="partner image">
                    </div>
                    <div class="partner">
                        <img src="<?= base_url('assets/frontend/'); ?>images/cl4.png" alt="partner image">
                    </div>
                    <div class="partner">
                        <img src="<?= base_url('assets/frontend/'); ?>images/cl2.png" alt="partner image">
                    </div>
...
<section class="gallery_area">
    <div class="gallery_contents_wrapper bgimage">
        <div class="bg_image_holder">
            <img src="<?= base_url('assets/frontend/'); ?>images/galbg.jpg" alt="">
        </div>
        <div class="container content_above">
            <div class="row">
