                            ...
                            <div class="upload_modules">
                                ...
                                <div class="modules__content">
                                        ...
                                        <div class="select-wrap select-wrap2">
                                            <select name="category" id="category" class="text_field">
                                                <?php foreach ($categorys as $category) : ?>
                                                    <?php if ($category['slug'] == $product['category']) : ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="product_name" class="text_field" value="<?= $product['name']; ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="upload_wrapper">
                                            ...
                                            <div class="progress_wrapper">
                                                ...
                                                <img width="100" class="img-thumbnail" src="<?= base_url('assets/img/products/') . $product['image']; ?>" alt="">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="price" id="rlicense" class="text_field" value="<?= $product['price']; ?>">
