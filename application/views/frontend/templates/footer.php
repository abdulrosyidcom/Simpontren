...
<footer class="footer-area">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="info-footer">
                            <div class="info__logo">
                                <img src="<?= base_url('assets/frontend/'); ?>images/flogo.png" alt="footer logo">
                            </div>
    ...
    <script src="<?= base_url('assets/frontend/'); ?>js/jquery-3.4.1.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA0C5etf1GVmL_ldVAichWwFFVcDfa1y_c"></script>
    <!-- inject:js -->
    <script src="<?= base_url('assets/frontend/'); ?>js/plugins.min.js"></script>
    <script src="<?= base_url('assets/frontend/'); ?>js/script.min.js"></script>
    <script src="<?= base_url('assets/backend/build/js/sweetalert/sweetalert2.all.min.js'); ?>"></script>
    <script src="<?= base_url('assets/frontend/'); ?>js/flashdata_home.js"></script>
    <script src="<?= base_url('assets/frontend/'); ?>js/flashdata_user_update.js"></script>
    <script src="<?= base_url('assets/frontend/'); ?>js/ckeditor/ckeditor.js"></script>
