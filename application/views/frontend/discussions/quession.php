            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="question-form cardify p-4">
                        <form action="<?= base_url('discussions/quession'); ?>" method="post">
                            <div class="form-group">
                                <label for="quession">Judul Prtanyaan</label>
                                <input type="text" id="quession" placeholder="Masukan judul disini" name="quession">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn--md btn-primary">Kirim Pertanyaan</button>
                            </div>
                        </form>
